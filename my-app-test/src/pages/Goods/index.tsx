  ...
  return (
    <div>
      ...
      <div className={styled.heart}>
        <div style={{ color: 'lightgreen', width:'15vw', padding: '5px', fontSize:'48px' }}>{good?.environmentalValue} <span role="img" aria-label="environmental icon" style={{ fontSize: '24px' }}>🌿</span></div>
